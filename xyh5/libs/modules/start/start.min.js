...
WeatherBase = function() {
    ...
    return t.prototype.playWeather = function(t) {
        this.imageList = t || [],
        0 == this._runing && (this._runing = !0, this._first = !0, this.onWeatherStart(), this.timerFrame > 0 || (this.timerFrame = 60), egret.startTick(this.weatherUpdateHandler, this), WeatherFactory.weatherRunlist[this.index] = this)
    },
    ...
    t.prototype.onWeatherInit = function() {},
    t.prototype.onWeatherStart = function() {},
    t.prototype.onWeatherUpdate = function() {},
    t.prototype.onWeatherStop = function() {},
    t
} ();
...
var NoticeUI = function(t) {
    ...
    e.prototype.onAddToStage = function(t) {
        ...
        e.texture = Main.Instance.GetImg("_ui_sbm_001@120_120_120_120"),
        e.y = 101,
        e.height = 1066,
        e.width = 700,
        e.x = -e.width >> 1,
        ...
        i.texture = Main.Instance.GetImg("_ui_sbm_003@258_0_255_0"),
        ...
        r.texture = Main.Instance.GetImg("_ui_bm_gonggao"),
        r.x = -50,
        r.y = 115,
        this.addChild(r);
        var a = new egret.Bitmap;
        a.texture = Main.Instance.GetImg("_ui_sbm_002@20_9_20_9"),
        a.x = -323,
        a.y = 189,
        a.height = 842,
        a.width = 640,
        ...
        n.touchEnabled = !0,
        n.addEventListener(egret.TouchEvent.TOUCH_TAP, this._OnClickClose, this),
        n.texture = Main.Instance.GetImg("_ui_bt_008_up"),
        n.x = 282,
        n.y = 91,
        this.addChild(n);
        var s = new egret.Bitmap;
        s.touchEnabled = !0,
        s.addEventListener(egret.TouchEvent.TOUCH_TAP, this._OnClickClose, this),
        s.texture = Main.Instance.GetImg("_ui_bt_007_up"),
        s.x = 247,
        s.y = 1052,
        this.addChild(s);
...
var GameServerData = function() {
    ...
    t.Init = function(e, i, r) {
        ...
        a.datas = i,
        t.PageData.push(a);
        for (var n = Math.max(Math.ceil(e / t.PAGE_COUNT), 1), s = n; s >= 1; --s) {
            var o = new GameServerPageData;
            o.name = (s - 1) * t.PAGE_COUNT + 1 + " - " + s * t.PAGE_COUNT + "服",
            o.index = s,
            o.datas = [],
            t.PageData.push(o)
        }
        t.PageData[1].datas = r,
        null != i && i.length > 0 && (t.SelectData = i[0]),
        null == t.SelectData && null != r && r.length > 0 && (t.SelectData = r[0])
    },
...
var GameServerDescData = function() {
    ...
    t.Get = function(e, i) {
        ...
        var r = new t;
        return r.id = e.sid,
        r.name = WindowData._GetServerName(e.sid),
        r.ip = e.addr,
        r.status = e.status,
        r.version = e.version,
        r
...
var HttpHelper = function() {
    ...
    return t.GetPlayerServerInfo = function(t, e, i) {
        ...
        r.open(WindowData._GetServerAddr() + "/get_player_serverinfo?token=" + t + "&platformid=" + WindowData._GetPlatformId(), egret.HttpMethod.GET),
        r.send(),
        r.addEventListener(egret.Event.COMPLETE, e, i),
        r.addEventListener(egret.IOErrorEvent.IO_ERROR, this.Error, this)
    },
    t.GetServerList = function(t, e, i) {
        var r = new egret.HttpRequest;
        r.responseType = egret.HttpResponseType.TEXT,
        r.open(WindowData._GetServerAddr() + "/get_serverlist?platformid=" + WindowData._GetPlatformId() + "&page=" + t, egret.HttpMethod.GET),
        r.send(),
    ...
    t.GetRandomName = function(t, e, i, r) {
        ...
        a.open(WindowData._GetServerAddr() + "/get_random_name?platformid=" + WindowData._GetPlatformId() + "&serverid=" + t + "&sex=" + e, egret.HttpMethod.GET),
        a.send(),
        a.addEventListener(egret.Event.COMPLETE, i, r),
        a.addEventListener(egret.IOErrorEvent.IO_ERROR, this.Error, this)
    },
    t.CheckName = function(t, e, i, r) {
        var a = new egret.HttpRequest;
        a.responseType = egret.HttpResponseType.TEXT,
        a.open(WindowData._GetServerAddr() + "/check_lock_name?platformid=" + WindowData._GetPlatformId() + "&serverid=" + t + "&name=" + e, egret.HttpMethod.GET),
        a.send(),
        a.addEventListener(egret.Event.COMPLETE, i, r),
        a.addEventListener(egret.IOErrorEvent.IO_ERROR, this.Error, this)
    },
    t.GetNotice = function(t, e) {
        ...
        i.open(WindowData._GetServerAddr() + "/get_total_notice?platformid=" + WindowData._GetPlatformId(), egret.HttpMethod.GET),
        i.send(),
        i.addEventListener(egret.Event.COMPLETE, t, e),
        i.addEventListener(egret.IOErrorEvent.IO_ERROR, this.Error, this)
    },
    t.SendPoint = function(e) {
        if (!t.m_Set[e] && Main.Instance) {
            ...
            var i = new egret.HttpRequest;
            i.responseType = egret.HttpResponseType.TEXT,
            i.open(WindowData._GetServerAddr() + "/set_account_point?account=" + Main.Instance.UserName + "&status=" + e, egret.HttpMethod.GET),
            i.send()
        }
    },
    t.Error = function() {
...
var LoadingUI = function(t) {
    ...
    return __extends(e, t),
    e.prototype.NewBar = function(t) {
        var e = new egret.Bitmap;
        e.x = -342,
        e.y = t,
        e.texture = Main.Instance.GetImg("_ui_bm_cjjindutiao01@63_0_60_0"),
        e.width = 685,
        ...
        return i.x = -296,
        i.y = t + 11,
        i.texture = Main.Instance.GetImg("_ui_bm_cjjindutiao02@14_0_8_0"),
        i.width = 593,
    ...
    e.prototype.onAddToStage = function(t) {
        ...
        e.texture = Main.Instance.GetSingleImg("ui_xzfwq_p_show"),
        e.touchEnabled = !0,
        e.x = -480,
        this.addChild(e),
        this.onResize(),
        ...
        ServerUI.IsNewServer(Main.Instance.mConnectServerData.id) && this._LoadTexture(0);
        ...
        r.touchEnabled = !0,
        r.addEventListener(egret.TouchEvent.TOUCH_TAP, this._OnClick, this),
    ...
    e.prototype.SetBarValue = function(t, e, i) {
        e > 1 ? e = 0 : 0 > e && (e = 0);
        var r = t.width,
        a = Math.round(e * r); (0 > a || a === 1 / 0) && (a = 0);
        var n = t.$scrollRect;
        return n || (n = egret.$TempRectangle),
    ...
    e.prototype._Loaded = function(t, e) {
        if (t) for (var i = 0; i < this.m_Textures.length; ++i) if (this.m_Textures[i].path == e) {
    ...
    e.prototype.Close = function() {
        if (egret.stopTick(this.Update, this), this.parent) {
            ...
            for (var t = 0,
            e = this.m_Textures; t < e.length; t++) {
                var i = e[t];
    ...
    e.prototype.Update = function(t) {
        ...
        this.img01W = this.SetBarValue(this.img01, this.s1 + (this.e1 - this.s1) * i, this.img01Tag);
        var r = (t - this.mt) % 2500;
        return this.img02W = this.SetBarValue(this.img02, r / 2500, this.img02Tag),
        this._UpdatePro(i),
        !1
    },
    ...
    e.prototype.onResize = function() {
        this.blackBg && (this.blackBg.x = -4 - (egret.MainContext.instance.stage.stageWidth >> 1), this.blackBg.y = -Main.Instance.mUIGroupYPos, this.blackBg.width = 1.2 * egret.MainContext.instance.stage.stageWidth, this.blackBg.height = 1.2 * egret.MainContext.instance.stage.stageHeight),
        this.bg && (this.bg.y = -Main.Instance.mUIGroupYPos, this.bg.height = egret.MainContext.instance.stage.stageHeight, this.bg.width = this.bg.height / 1280 * 960, this.bg.x = -this.bg.width >> 1)
    },
...
var LoginUI = function(t) {
    ...
    return __extends(e, t),
    e.prototype.NewServerBg = function() {
        var t = new egret.Bitmap;
        t.texture = Main.Instance.GetImg("_ui_bm_fuwuqimingchengbg@24_0_24_0"),
    ...
    e.prototype.NewSelServerBg = function() {
        ...
        t.width = 438,
        t.touchEnabled = !0,
        t.addEventListener(egret.TouchEvent.TOUCH_TAP, this._OnClickServer, this),
        this.addChild(t);
        var e = new egret.Bitmap;
        e.texture = Main.Instance.GetImg("_ui_icon_tongchang"),
        e.x = -201,
        e.y = 928,
        this.addChild(e);
        var i = new egret.Bitmap;
        i.texture = Main.Instance.GetImg("_ui_bt_dianjixuanfu"),
        i.x = 97,
        i.y = 929,
        this.addChild(i);
    ...
    e.prototype.NewStarBtn = function() {
        var t = new egret.Bitmap;
        t.texture = Main.Instance.GetImg("_ui_bt_kaishiyouxi"),
        t.touchEnabled = !0,
        t.x = -176,
        t.y = 1015,
        this.addChild(t),
        t.addEventListener(egret.TouchEvent.TOUCH_TAP, this._OnClickLogin, this)
    },
    e.prototype.onAddToStage = function(t) {
        this.removeEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
        var e = new egret.Bitmap;
        e.touchEnabled = !0,
        e.texture = Main.Instance.GetImg("_ui_bt_gonggao"),
        e.y = 37,
        e.x = 222,
        e.addEventListener(egret.TouchEvent.TOUCH_TAP, this._OnClickNotice, this),
        this.addChild(e),
        this.NewServerBg(),
        this.NewSelServerBg(),
        this.NewStarBtn(),
        this.SetCurServerName(),
        Main.Instance.NoticeStatus && Main.Instance.ShowNoticeUI()
    },
    e.prototype.Close = function() {
        this.parent && this.parent.removeChild(this)
    },
...
var Main = function(t) {
    function e() {
        ...
        return i.addEventListener(egret.Event.ADDED_TO_STAGE, i.onAddToStage, i),
        i
    }
    return __extends(e, t),
    e.$GetThmPath = function(t, e) {
        if (e) {
    ...
    e.prototype.onAddToStage = function(t) {
        ...
        WindowData._GetBGImg() && (this.m_BGImg = new egret.Bitmap, this.m_UIGroup.addChild(this.m_BGImg), this._LoadGroup((i = {},
        i.__BG_IMG__ = WindowData._GetBGImg(), i))),
        ...
        WindowData._DirectLogin() ? window._LoginToken(function(t, i) {
            e.mToken = t,
            e._DoParsePlayerServerInfo(i)
        }) : window._LoginToken(function(t) {
            e.mToken = t,
            HttpHelper.GetPlayerServerInfo(t, e._DoGetPlayerServerInfo, e)
        });
        var i
    ...
    e.prototype._DoParsePlayerServerInfo = function(t) {
        var e = JSON.parse(t);
        if (1 != e.result) return void alert(e.result_msg);
        var i = function(t) {
            if (!t) return [];
        ...
        if (GameServerData.Init(e.data.maxid, n, d), 0 == GameServerData.PageData[0].datas.length) {
            for (var c = GameServerData.PageData[1].datas, m = 0; m < c.length; ++m) {
                var h = c[m];
                if (h.CanEnter()) return HttpHelper.SendPoint(4),
                this.m_CreateRoleData = h,
                this._LoadGroup(this.mLoadResGroup02),
                void this._SetNextStep(2)
            }
    ...
    e.prototype._SetNextStep = function(t) {
        ...
        this.m_NextStepType = t,
        this._CreateScene()
    },
    e.prototype._LoadSheet = function(t) {
        this.m_CurLoadGroup.push(t),
        RES.getResByUrl(t, this._OnLoadItem, this, RES.ResourceItem.TYPE_SHEET)
    },
    ...
    e.prototype.UpdateLoadingUI = function(t, e, i, r, a) {
        for (var n = this.m_UIGroup.numChildren - 1; n >= 0; --n) {
            var s = this.m_UIGroup.getChildAt(n);
    ...
    e.prototype.ShowLoadingImg = function() {
        null == this.m_LoadingImg && (this.m_LoadingImg = new egret.Bitmap, this.m_LoadingImg.texture = this.GetImg("_start_load_Reel"), this.m_LoadingImg.anchorOffsetX = this.m_LoadingImg.width >> 1, this.m_LoadingImg.anchorOffsetY = this.m_LoadingImg.height >> 1, this.onResize()),
        this.m_LoadingImg.parent && this.m_LoadingImg.parent.removeChild(this.m_LoadingImg),
    ...
    e.prototype.HideLoadingImg = function() {
        egret.stopTick(this.UpdateLoadingImgAnim, this),
        this.m_TimeOutId && (egret.clearTimeout(this.m_TimeOutId), this.m_TimeOutId = null),
        this.m_LoadingImg && this.m_LoadingImg.parent && this.m_LoadingImg.parent.removeChild(this.m_LoadingImg)
    },
    e.prototype.onResize = function() {
    ...
    e.prototype._CheckServerState = function(t) {
        return t ? t.version ? (0 == t.status || t.status > 2) && !this.GmLevel ? (alert("服务器维护中，请稍后重试！！！"), !1) : !0 : (alert("服务器正在维护，请稍后重试！！！"), !1) : (alert("服务器数据为空，请重新登录！！！"), !1)
    },
    e.prototype.ConnectServer = function(t, e) {
        if (this._CheckServerState(t)) {
            ...
            if (i == Socket.STATUS_CHECKING) return console.log("连接成功"),
            void(e ? e() : console.log("not callback func !"));
            this.DoShowLoadingImg(),
            this.mConnectServerData = t;
            var r = t.ip.split(":"),
            a = r[0],
            n = r[1];
            this.m_ConCallback = e,
    ...
    e.prototype.GetSingleImg = function(t) {
        ...
        return e || (e = this.mLoadResGroup05[t]),
        e || console.error("not name " + t),
        RES.getAnalyzer(RES.ResourceItem.TYPE_IMAGE).getRes(e)
    },
    e.prototype._OnLoadItem = function(t, e) {
        for (var i = 0,
        r = this.m_CurLoadGroup.length; r > i; ++i) if (this.m_CurLoadGroup[i] == e) {
            this.m_CurLoadGroup.splice(i, 1);
            break
        }
        console.log("loaded => " + e),
        this.m_BGImg && e == WindowData._GetBGImg() && t && (this.m_BGImg.texture = t, this.m_BGImg.x = -(t.textureWidth >> 1)),
...
var TestScreenAdapter = function(t) {
    ...
    return __extends(e, t),
    e.prototype.calculateStageSize = function(t, e, i, r, a) {
        r = 720,
        a = 1280;
        var n = e,
        s = i,
        ...
        u = e / i,
        c = .75;
        return u > c ? (r = Math.round(l * c), o = r, n = Math.round(r * d)) : .5 > u ? (a = Math.round(18 * g / 9), h = a, s = Math.round(a * _)) : 9 / 16 > u ? (a = Math.round(g / u), h = a, s = Math.round(a * _)) : o = Math.round(e / d),
        n % 2 != 0 && (n += 1),
        s % 2 != 0 && (s += 1),
        {
            stageWidth: o,
...
var CreateRoleUI = function(t) {
    ...
    return __extends(e, t),
    e.prototype.m_CreateThm1 = function() {
        var t = this,
        i = new egret.Bitmap;
        i.texture = Main.Instance.GetImg("_ui_bm_mingzibg@20_19_19_19"),
        i.y = 1021,
        i.x = -146,
        i.width = 292,
        i.height = 74,
        ...
        var r = new egret.Bitmap;
        r.texture = Main.Instance.GetImg("_ui_cjjs_bm_wenbenbg"),
        r.y = 812,
        r.x = -192,
        this.addChild(r);
        ...
        var s = new egret.Bitmap;
        s.touchEnabled = !0,
        s.texture = Main.Instance.GetImg("_ui_bt_nan"),
        this.sex1 = s,
        s.x = 174,
        s.y = 1015,
        this.addChild(s),
        ...
        o.touchEnabled = !0,
        this.sex2 = o,
        o.texture = Main.Instance.GetImg("_ui_bt_nv"),
        o.x = 269,
        o.y = 1015,
        this.addChild(o),
        ...
        this.sel1 = h,
        h.texture = Main.Instance.GetImg("_ui_cjjs_bm_gou"),
        h.touchEnabled = !1,
        h.x = 207,
        h.y = 1058,
        this.addChild(h);
        ...
        this.sel2 = _,
        _.texture = Main.Instance.GetImg("_ui_cjjs_bm_gou"),
        h.touchEnabled = !1,
        _.x = 304,
        _.y = 1058,
        this.addChild(_)
    ...
    e.prototype.AddSelGroup = function() {
        ...
        var r = new egret.Bitmap;
        r.touchEnabled = !0,
        r.texture = Main.Instance.GetImg("_ui_icon_renzhu"),
        r.x = -202,
        r.y = -4,
        r.addEventListener(egret.TouchEvent.TOUCH_TAP,
        function() {
            t.Select(0)
        },
        this),
        ...
        var a = new egret.Bitmap;
        a.touchEnabled = !0,
        a.texture = Main.Instance.GetImg("_ui_icon_xianzhu"),
        a.x = -63,
        a.y = -4,
        ...
        var n = new egret.Bitmap;
        n.touchEnabled = !0,
        n.texture = Main.Instance.GetImg("_ui_icon_mozhu"),
        n.x = 77,
        n.y = -4,
        ...
        e.SetDownState(n);
        var s = new egret.Bitmap;
        s.texture = Main.Instance.GetImg("_ui_cjjs_bm_renzu"),
        s.x = -169,
        s.y = 982,
        this.addChild(s);
        var o = new egret.Bitmap;
        o.texture = Main.Instance.GetImg("_ui_cjjs_bm_xianzu"),
        o.x = -28,
        o.y = 982,
        this.addChild(o);
        var h = new egret.Bitmap;
        h.texture = Main.Instance.GetImg("_ui_cjjs_bm_mozu"),
        h.x = 109,
        h.y = 982,
        this.addChild(h);
        ...
        d.texture = Main.Instance.GetImg("_ui_cjjs_bm_xuanzhongxiaoguo"),
        d.x = -243,
        d.y = -48,
        _.addChild(d),
        this.mSelImg[0] = d;
        var l = new egret.Bitmap;
        l.texture = Main.Instance.GetImg("_ui_cjjs_bm_xuanzhongxiaoguo"),
        l.x = -105,
        l.y = -48,
        _.addChild(l),
        this.mSelImg[1] = l;
        var g = new egret.Bitmap;
        g.texture = Main.Instance.GetImg("_ui_cjjs_bm_xuanzhongxiaoguo"),
        g.x = 35,
        g.y = -48,
        _.addChild(g),
        this.mSelImg[2] = g
    ...
    e.prototype.onAddToStage = function(t) {
        ...
        var r = new egret.Bitmap;
        r.x = -360,
        r.texture = Main.Instance.GetSingleImg("_ui_cjjs_bm_ditu"),
        this.addChild(r),
        this.m_CreateThm1(),
        this.AddSelGroup(),
        ...
        a.texture = Main.Instance.GetImg("_ui_bm_touzi"),
        a.y = 1025,
        a.x = 78,
        this.addChild(a),
        e.SetDownState(a);
        ...
        n.texture = Main.Instance.GetImg("_ui_bt_kaishiyouxi"),
        n.y = 1105,
        n.x = -176,
        this.addChild(n),
        e.SetDownState(n);
        var s = new egret.Bitmap;
        s.touchEnabled = !0,
        s.texture = Main.Instance.GetImg("_ui_bt_jiantou"),
        s.x = -341,
        s.y = 618,
        s.addEventListener(egret.TouchEvent.TOUCH_TAP,
        function() {
        ...
        var o = new egret.Bitmap;
        o.touchEnabled = !0,
        o.texture = Main.Instance.GetImg("_ui_bt_jiantou"),
        o.x = 341,
        o.y = 618,
        o.scaleX = -1,
        o.addEventListener(egret.TouchEvent.TOUCH_TAP,
    ...
    e.prototype._DoGo = function() {
        ...
        return null == e || "" == e ? void alert("名称不能为空") : (this.SendPoint(2), this.m_CheckName = e, this.m_CheckIndex = this.m_Index, void Main.Instance.ConnectServer(this.m_ServerData,
        function() {
            t.SendPoint(3),
            HttpHelper.CheckName(t.m_ServerData.id, e, t._Go, t)
        }))
    },
    ...
    e.prototype._Go = function(t) {
        ...
        if (200 == e.status) if (0 == e.data.result) {
            ...
            var a = ["", "角色不存在", "重复创建角色", "创建角色失败", "性别职业错误", "角色名称重复", "角色名含特殊字符", "角色名过长", "角色名含有屏蔽字", "角色名称重复"][e.data.result] || "名称错误";
            alert(a)
        }
    },
    ...
    e.prototype.UpdateSel = function() {
        ...
        for (var e = this.m_Job - 1,
        i = 0; i < this.mSelImg.length; i++) this.mSelImg[i].visible = i == e;
    ...
    e.prototype.Update = function(t) {
        if (this.parent && this.$stage) {
            ...
            for (var r = this.m_TweenList.length - 1; r >= 0; r--) {
                var a = this.m_TweenList[r];
                a.time += i;
                var n = e.circOut(a.time / a.duration);
                a.time >= a.duration && (n = 1, this.m_TweenList.splice(r, 1));
                for (var s in a.prop) {
                    var o = a.prop[s],
...
var ServerUI = function(t) {
    ...
    e.prototype.onAddToStage = function(t) {
        ...
        this.addChild(i);
        var r = new egret.Bitmap;
        r.texture = Main.Instance.GetImg("_ui_sbm_002@20_9_20_9"),
        r.x = -323,
        r.y = 189,
        r.height = 842,
        r.width = 217,
        ...
        this.addChild(a);
        var n = new egret.Bitmap;
        n.texture = Main.Instance.GetImg("_ui_cj_bm_fuwuqixuanzhe"),
        n.x = -93,
        n.y = 115,
        this.addChild(n);
        var s = new egret.Bitmap;
        s.touchEnabled = !0,
        s.addEventListener(egret.TouchEvent.TOUCH_TAP, this._OnClickClose, this),
        s.texture = Main.Instance.GetImg("_ui_bt_008_up"),
        s.x = 282,
        s.y = 91,
        this.addChild(s);
        var o = new egret.Bitmap;
        o.touchEnabled = !0,
        o.addEventListener(egret.TouchEvent.TOUCH_TAP, this._OnClickClose, this),
        o.texture = Main.Instance.GetImg("_ui_bt_007_up"),
        o.x = 247,
        o.y = 1052,
        this.addChild(o);
        ...
        this.addChild(_),
        this.m_LeftScrollView = new ServerScrollView(_, ServerUIItem1, this._LeftClick, this),
    ...
    e.prototype._LeftClick = function(t) {
        0 != t && GameServerData.GetPageData(GameServerData.PageData[t].index),
        this.m_RightScrollView.SetDatas(GameServerData.PageData[t].datas)
    },
    e.prototype._RightClick = function(t) {
        for (var e = this.m_RightScrollView.GetData(t), i = GameServerData.PageData[0].datas, r = 0, a = i.length; a > r; ++r) if (i[r].id == e.id) return void Main.Instance.StartLoadGame(e);
        Main.Instance.ShowCreateUI(e)
    },
    e.IsNewServer = function(t) {
        for (var e = GameServerData.PageData[0].datas, i = 0, r = e.length; r > i; ++i) if (e[i].id == t) return ! 1;
        return ! 0
    },
    e.prototype._OnClickClose = function() {
        this.Close()
...
var ServerScrollView = function() {
    function t(t, e, i, r) {
        ...
        this.m_Group.width = t.width,
        this.m_Group.height = t.height,
        t.setContent(this.m_Group)
    }
    ...
    t.prototype._AddItem = function(t, e) {
        ...
        var i = this.GetItme();
        return i.addEventListener(egret.TouchEvent.TOUCH_TAP, this._ItemClick, this),
        i.itemIndex = t,
        i.y = this.m_ItemCls.Height * t,
        i.SetData(this.m_Datas[t]),
        -1 == e ? this.m_Group.addChildAt(i, 0) : this.m_Group.addChild(i),
        !0
    },
...
var ServerUIItem1 = function(t) {
    function e() {
        ...
        var r = new egret.Bitmap;
        r.touchEnabled = !1,
        r.texture = Main.Instance.GetImg("_ui_bt_fuwuqi02"),
        r.x = i.width - r.width >> 1,
        r.y = i.height - r.height >> 1,
        i.addChild(r);
        var a = i.light = new egret.Bitmap;
        return a.touchEnabled = !1,
        a.texture = Main.Instance.GetImg("_ui_bt_fuwuqi0"),
        a.x = i.width - a.width >> 1,
        a.y = i.height - a.height >> 1,
        i.addChild(a),
        i.label = new egret.TextField,
        i.label.touchEnabled = !1,
        i.label.size = 30,
        i.label.textColor = ServerUI.COLOR,
        i.label.width = r.width,
        i.label.height = r.height,
        i.label.x = r.x,
        i.label.y = r.y,
        i.label.textAlign = egret.HorizontalAlign.CENTER,
        i.label.verticalAlign = egret.VerticalAlign.MIDDLE,
        i.addChild(i.label),
        i
    }
    return __extends(e, t),
...
var ServerUIItem2 = function(t) {
    function e() {
        ...
        i.height = e.Height;
        var r = new egret.Bitmap;
        return r.touchEnabled = !1,
        r.texture = Main.Instance.GetImg("_ui_bm_fuwuqibg@60_54_58_58"),
        r.width = e.Width - 20,
        r.height = e.Height - 10,
        ...
        i.label.verticalAlign = egret.VerticalAlign.MIDDLE,
        i.addChild(i.label),
        i.flagImg = new egret.Bitmap,
        i.flagImg.touchEnabled = !1,
        i.addChild(i.flagImg),
        i.hotImg = new egret.Bitmap,
        i.hotImg.touchEnabled = !1,
        i.hotImg.x = 30,
        i.hotImg.y = 50,
        i.addChild(i.hotImg),
        i.headImg = new egret.Bitmap,
        i.headImg.touchEnabled = !1,
        i.headImg.width = 81,
        i.headImg.height = 81,
        i.headImg.x = 305,
        i.headImg.y = 15,
        i.headImg.texture = Main.Instance.GetImg("_ui_bm_touxiangkuang02"),
        i.headImg.visible = !1,
        i.addChild(i.headImg),
        i.playername = new egret.TextField,
        i.playername.touchEnabled = !1,
        i.playername.size = 18,
        i.playername.textColor = ServerUI.COLOR,
        i.playername.height = r.height,
        i.playername.x = 300,
        i.playername.y = r.y + 100,
        i.playername.width = 92,
        i.playername.textAlign = egret.HorizontalAlign.CENTER,
        i.addChild(i.playername),
        i.kuangImg = new egret.Bitmap,
        i.kuangImg.texture = Main.Instance.GetImg("_ui_bm_touxiangkuang"),
        i.kuangImg.width = 92,
        i.kuangImg.height = 92,
        i.kuangImg.x = 300,
        i.kuangImg.y = 10,
        i.kuangImg.visible = !1,
        i.addChild(i.kuangImg),
        i
    }
    return __extends(e, t),
    e.prototype.SetData = function(t) {
        ...
        e ? (this.flagImg.texture = Main.Instance.GetImg(1 == e ? "_ui_bm_xin": "_ui_bm_hot"), this.hotImg.texture = Main.Instance.GetImg("_ui_icon_tongchang")) : (this.flagImg.texture = Main.Instance.GetImg("_ui_bm_weihuzhong"), this.hotImg.texture = Main.Instance.GetImg("_ui_icon_weihu")),
        this.SetHeadData()
    },
    e.prototype.SetHeadData = function() {
        for (var t = this.Desc.ip,
        e = Main.Instance.playerServerData.data.recent,
        i = !1,
        r = 0; r < e.length; r++) {
            var a = e[r];
            if (t == a.addr) {
                var n = a.job || 1,
                s = a.sex || 0;
                this.headImg.texture = Main.Instance.GetImg("head" + n + s),
...
var Socket = function() {
    ...
    t.prototype.connect = function(e, i) {
        this.updateStatus(t.STATUS_CONNECTING),
        this._host = e,
        this._port = i,
        this.Connect(e, i)
    },
    t.prototype.Connect = function(e, i) {
        ...
        if (WindowData.IsHttps()) {
            var n = WindowData._GetPlatformId();
            n > 1e4 && (n %= 10);
            var s = WindowData._GetCenterAddr();
            a = "wss://" + s + ":50000/" + i % 1e4 + "/"
        } else a = "ws://" + e + ":" + i;
        this.socket_.connectByUrl(a),
        console.log("H5游戏分享论坛-h5.ssrsu.com温馨提示：正在连接中......"),
        window.setTimeout(function() {
            r._socketStatus == t.STATUS_CONNECTING && (alert("连接超时"), r.close())
        },
        1e4)
    },
    t.prototype.close = function() {
        console.log("H5游戏分享论坛-h5.ssrsu.com温馨提示：close socket！"),
        this.socket_ && this.socket_.close(),
        this.updateStatus(t.STATUS_DISCONNECT),
    ...
    t.prototype.onSocketConnected = function(e) {
        console.log("H5游戏分享论坛-h5.ssrsu.com温馨提示：与服务器连接成功！port:" + this._port),
        this.updateStatus(t.STATUS_CHECKING),
        egret.stopTick(this._SendHeartBeat, this),
    ...
    t.prototype.onSocketRead = function(t) {
        if (this.proxy) {
            ...
            i.readBytes(e, 0),
            this.proxy.onSocketRead(new Uint8Array(e.buffer.slice(0, r)))
        }
    },
    t.prototype.onSocketClose = function(e) {
        console.log("H5游戏分享论坛-h5.ssrsu.com温馨提示：与服务器的断开连接！port:" + this._port);
    ...
    t.prototype.updateStatus = function(t) {
        if (this._socketStatus != t) {
            ...
            this._socketStatus = t,
            this.onFinishCheck(t, e)
        }
    },
    t.prototype.onFinishCheck = function(e, i) {
        e == t.STATUS_COMMUNICATION ? console.log("H5游戏分享论坛-h5.ssrsu.com温馨提示：与服务器建立通信成功！port:" + this._port) : e == t.STATUS_CHECKING || e == t.STATUS_DISCONNECT,
    ...
    t.STATUS_CHECKING = 2,
    t.STATUS_COMMUNICATION = 3,
    t.STATUS_DISCONNECT = 4,
    t.ins = function() {
...
var Base64 = function() {
    ...
    return t.encode = function(t) {
        var e, i, r, a, n, s, o, h = "",
        _ = 0;
        for (t = this._utf8_encode(t); _ < t.length;) e = t.charCodeAt(_++),
        i = t.charCodeAt(_++),
        r = t.charCodeAt(_++),
        a = e >> 2,
        n = (3 & e) << 4 | i >> 4,
        ...
        h = h + this._keyStr.charAt(a) + this._keyStr.charAt(n) + this._keyStr.charAt(s) + this._keyStr.charAt(o);
        return h
    },
    t.decode = function(t) {
        var e, i, r, a, n, s, o, h = "",
        _ = 0;
        for (t = t.replace(/[^A-Za-z0-9\+\/\=]/g, ""); _ < t.length;) a = this._keyStr.indexOf(t.charAt(_++)),
        n = this._keyStr.indexOf(t.charAt(_++)),
        s = this._keyStr.indexOf(t.charAt(_++)),
        o = this._keyStr.indexOf(t.charAt(_++)),
        e = a << 2 | n >> 4,
        i = (15 & n) << 4 | s >> 2,
        r = (3 & s) << 6 | o,
        h += String.fromCharCode(e),
        64 != s && (h += String.fromCharCode(i)),
        64 != o && (h += String.fromCharCode(r));
    ...
    t._utf8_decode = function(t) {
        for (var e, i, r = "",
        a = 0,
        n = 0; a < t.length;) e = t.charCodeAt(a),
        128 > e ? (r += String.fromCharCode(e), a++) : e > 191 && 224 > e ? (i = t.charCodeAt(a + 1), r += String.fromCharCode((31 & e) << 6 | 63 & i), a += 2) : (i = t.charCodeAt(a + 1), n = t.charCodeAt(a + 2), r += String.fromCharCode((15 & e) << 12 | (63 & i) << 6 | 63 & n), a += 3);
        return r
    },
...
var WeatherFactory = function() {
    ...
    return t.getFlower = function() {
        ...
        return this._weatherFlower = this._weatherFlower || new WeatherFlower,
...
var WeatherFlower = function(t) {
    ...
    return __extends(e, t),
    e.prototype.setStageTarget = function(t) {
        this.stageTarget = t
    },
    ...
    e.prototype.onWeatherUpdate = function() {
        ...
        if (null != this.imageList && 0 != this.imageList.length) {
            ...
            if (this.r_Max != this.MAX_COUNT && e - this._lastTime >= 1e3 && (this.r_Max += 1, this.r_Max > this.MAX_COUNT && (this.r_Max = this.MAX_COUNT), this._lastTime = e), this.r_R_List.length < this.r_Max && this.r_P_List.length > 0 && e - this.r_L_Last_Time > this.r_L_Delay) {
                ...
                t.visible = !0,
                t.type = 0,
                t.texture = this.imageList[10 * Math.random() % 3 << 0];
                var i = egret.MainContext.instance.stage;
                t.x = i.stageWidth * Math.random() + 1,
                t.y = 20 * Math.random() + 5,
                t.sy = t.y,
                t.targety = i.stageHeight / 2 + i.stageHeight / 2 * Math.random(),
                t.scaleX = 0,
                t.scaleY = 0,
                t.sScale = .5 * Math.random() + .5,
                t.alpha = 0,
                t.rotationPlus = 1.5 * (2 * Math.random() - 1),
                t.sptx = Math.random() / 20 + .01,
                t.speedx = Math.random() - Math.random() - 2,
                t.speedy = 3 * Math.random() + 3,
                null == t.parent && this.stageTarget.addChild(t),
                this.r_R_List.push(t)
            }
            for (var r = 0; r < this.r_R_List.length; r++) if (t = this.r_R_List[r], t.update(), t.rotation += t.rotationPlus, t.isDeath) this.r_R_List.splice(r--, 1),
            this.r_P_List.push(t),
            t.visible = !1;
            else {
                var a = (t.y - t.sy) / (t.targety - t.sy);.2 >= a ? (t.alpha = a / .2, t.scaleX = t.scaleY = t.sScale * t.alpha) : a >= .8 && (t.alpha = (1 - a) / .2, t.scaleX = t.scaleY = t.sScale * t.alpha)
            }
        }
    },
    e.prototype.onWeatherStop = function() {
        var t, e;
        for (t = 0; t < this.r_R_List.length; t++) e = this.r_R_List[t],
        e.visible = !0,
        this.Remove(e);
        for (t = 0; t < this.r_P_List.length; t++) e = this.r_P_List[t],
        e.visible = !0,
        this.Remove(e);
